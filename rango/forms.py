...
class PageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        # we don't need every field in our model present
        # some fields may allow NULL values, may not want to include them
        # we can either exclue category field from the form:
        exclude = ('category',)
    ...
    def clean(self):
        ...
        # if url is non empty and doesnt start with `http://`
        # prepend `http://`
